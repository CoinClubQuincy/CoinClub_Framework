...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UserDefaults.standard.register(defaults: [MessageOptionKey: MessageOption.noLineEnding.rawValue,
                                                  ReceivedMessageOptionKey: ReceivedMessageOption.newline.rawValue])
        AppData.sharedInstance.appDelegate = self
        return true
    }
    ...
    func applicationWillEnterForeground(_ application: UIApplication) {
        AppData.sharedInstance.isPhoneUnlocked = false
        AppData.sharedInstance.homeViewController?.viewDidAppear(false)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "WallApp")
